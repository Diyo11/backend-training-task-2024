...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21);      //乘法運算下會轉型成數字 8*3=24，因此大於21
...
const gymCoach = {
  wang:{
    ...
    personalData:"王教練擁有 5 年教學經驗，專精於提升學員的肌力與減脂，適合希望快速達成體能目標的學員。",
    isRecruitingStudents:true
  },
  lee:{
    expertise:["瑜伽","體態雕塑"],
    course:[
    ...
    personalData:"李教練是一位瑜伽大師，擁有 10 年教學經驗，擅長幫助學員雕塑完美體態，適合希望改善姿態與柔軟度的學員。",
    isRecruitingStudents:false
  }
}; 
// 練習：使用物件變數定義兩位教練的資訊
...
// 練習：週二、週三、週四、週五、週六
exerciseRecords.forEach(function(item){
